  ...
  return (
    <div className="bg-slate-50 px-6 pt-12 pb-24 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-quicksandBold text-orange-600/70">
          Contact us
        </h2>
        <p className="mt-2 text-md text-slate-600 font-quicksandBold">
      ...
      >
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <textarea
                ...
                id="message"
                rows={4}
                className="block w-full rounded-md border-0 px-3.5 py-2 text-slate-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6 font-quicksand"
              />
            </div>
          </div>
        </div>
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-orange-600/70 px-3.5 py-2.5 text-center text-sm font-quicksandBold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600"
          >
            Send Message
          </button>
        </div>
