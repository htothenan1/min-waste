      ...
      <div className="flex justify-center">
        <div className="flex flex-col justify-center items-center border md:hover:scale-110 rounded-md mt-20 sm:w-3/4 md:w-1/2 p-4">
          ...
          <p className="my-2 text-sm">
            ...
            user's kitchen. Simply knowing what food you have in your kitchen
            has been shown to reduce an individual's food waste significantly.
            Additionally, I will develop features that teach the user about the
            minimum-waste lifestyle, and how to apply it.
          </p>
          <h1 className="text-lg text-slate-600 font-semibold">
          ...
          <p className="my-2 text-sm">
            ...
            1 in 8 Americans don't have enough food to eat each day. Isn't that
            absurd? That wasted food also makes up 20 percent of all landfills,
            and ends up being a terrible producer of greenhouse gasses. The
            resources that are spent to produce and deliver uneaten food to
            consumers are immense. The only way this problem goes away is if we
            can collectively improve our behavior, and stop wasting so much damn
            food. Additionally, on a less altruistic note, the less food you
            waste, the more money you save. So let's do this thing!
          </p>
          <h1 className="text-lg text-slate-600 font-semibold">
