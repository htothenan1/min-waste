export const thought = [
  ...
  "“Like any pursuit, artistic or otherwise, the lack of choices usually inspire a kind of creativity that you're forced into.” F Chef Dan Barber",
  "“Cutting food waste is a delicious way of saving money, helping to feed the world and protect the planet.” - Tristram Stuart",
  "“We are trashing our land to grow food that no one eats.” - Tristram Stuart",
  ...
  '"The more we throw away, the more we waste what we have." - Chris Goodall',
  '"Be the change you wish to see in the world." - Mahatma Gandhi',
  '"Every time you waste food, you waste water." - Sylvia Earle',
  '"Nature provides a free lunch, but only if we control our appetites." - William Ruckelshaus',
  '"The earth does not belong to us; we belong to the earth." - Marlee Matlin',
  "The energy wasted on producing food that is never eaten could power the entire African continent for three days.",
  "Food waste is responsible for significant water wastage, with 24% of all freshwater used for agriculture going to waste.",
  "Food waste in developed countries is often due to consumers discarding food that is perfectly safe to eat, influenced by arbitrary expiration dates.",
  "Food waste is a significant contributor to deforestation, as land is cleared for agricultural purposes.",
  "Over 800 million people around the world suffer from hunger, while we waste billions of tons of food annually.",
  "Consider each meal as an opportunity to make a positive impact on the environment.",
  "Think about the resources that went into producing the food you are about to throw away.",
  "Reflect on the fact that food waste contributes to climate change and its effects on future generations.",
  "Picture a world with cleaner air, less pollution, and more sustainable agriculture due to reduced food waste.",
  "Realize that by reducing food waste, you are setting an example for your family, friends, and community.",
  "Envision the satisfaction of saving money and resources by using everything you buy.",
  "Remember, small changes in daily habits can lead to significant reductions in food waste.",
  "By being mindful and making conscious choices, you can play a vital role in reducing food waste and its environmental impact.",
]
